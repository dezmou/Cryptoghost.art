...
## Cryptoghost is the only NFT that doesn't rely on external hosting for pictures assets, everything is on the Ethereum blockchain, while Ethereum exist, picture exist.
