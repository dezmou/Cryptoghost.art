...
## Cryptoghost is the first NFT that doesn't rely on external hosting for pictures assets, everything is on the Ethereum blockchain, as long as Ethereum exists, picture exists.
